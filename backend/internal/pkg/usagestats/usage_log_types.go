...
type DashboardStats struct {
	...
	TotalReportedInputTokens           int64   `json:"total_reported_input_tokens"`
	TotalReportedCacheCreationTokens   int64   `json:"total_reported_cache_creation_tokens"`
	TotalReportedForcedCacheReadTokens int64   `json:"total_reported_forced_cache_read_tokens"`
	...
	TodayReportedInputTokens           int64   `json:"today_reported_input_tokens"`
	TodayReportedCacheCreationTokens   int64   `json:"today_reported_cache_creation_tokens"`
	TodayReportedForcedCacheReadTokens int64   `json:"today_reported_forced_cache_read_tokens"`
