...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.POST("/import/chatgpt-cookie/preview", h.Admin.Account.PreviewChatGPTCookie)
		accounts.POST("/import/chatgpt-cookie", h.Admin.Account.ImportChatGPTCookie)
		accounts.POST("/:id/reimport/chatgpt-cookie", h.Admin.Account.ReimportChatGPTCookie)
