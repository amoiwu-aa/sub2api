...
const (
	...
	RoleAffiliateAdmin = domain.RoleAffiliateAdmin
	RoleUser           = domain.RoleUser
)

// RoleCanAccessAdminPanel reports whether a role may enter /admin routes.
func RoleCanAccessAdminPanel(role string) bool {
	return role == RoleAdmin || role == RoleAffiliateAdmin
}
