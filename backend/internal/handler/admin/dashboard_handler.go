...
func (h *DashboardHandler) GetStats(c *gin.Context) {
	...
	response.Success(c, gin.H{
		...
		"total_reported_input_tokens":               stats.TotalReportedInputTokens,
		"total_reported_cache_creation_tokens":      stats.TotalReportedCacheCreationTokens,
		"total_reported_forced_cache_read_tokens":   stats.TotalReportedForcedCacheReadTokens,
		...
		"today_reported_input_tokens":               stats.TodayReportedInputTokens,
		"today_reported_cache_creation_tokens":      stats.TodayReportedCacheCreationTokens,
		"today_reported_forced_cache_read_tokens":   stats.TodayReportedForcedCacheReadTokens,
