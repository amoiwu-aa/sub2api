...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		PaymentExternalRedeemPurchaseEnabled:                   paymentCfg.ExternalRedeemPurchaseEnabled,
		PaymentExternalRedeemPurchaseURL:                       paymentCfg.ExternalRedeemPurchaseURL,
		PaymentExternalRedeemPurchaseLabel:                     paymentCfg.ExternalRedeemPurchaseLabel,
