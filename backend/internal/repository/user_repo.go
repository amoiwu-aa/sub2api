...
func (r *userRepository) GetByID(ctx context.Context, id int64) (*service.User, error) {
	if _, err := r.SettleExpiredBalanceGrants(ctx, id); err != nil {
		return nil, err
	}
...
func (r *userRepository) UpdateBalance(ctx context.Context, id int64, amount float64) error {
	_, err := r.adjustBalanceWithGrantLedger(ctx, id, amount, false, false, true)
	return err
}

func (r *userRepository) ApplyRedeemBalanceAdjustment(ctx context.Context, id int64, delta float64) error {
	_, err := r.adjustBalanceWithGrantLedger(ctx, id, delta, true, false, false)
	return err
}
...
func (r *userRepository) DeductBalance(ctx context.Context, id int64, amount float64) error {
	_, err := r.adjustBalanceWithGrantLedger(ctx, id, -amount, false, false, false)
	return err
}
...
func (r *userRepository) DeductAvailableBalance(ctx context.Context, id int64, amount float64) (deducted float64, err error) {
	...
	return r.deductAvailableBalanceWithGrantLedger(ctx, id, amount)
}
...
func (r *userRepository) AdjustBalance(ctx context.Context, id int64, delta float64) (service.BalanceChange, error) {
	return r.adjustBalanceWithGrantLedger(ctx, id, delta, false, true, false)
}
...
func (r *userRepository) SetBalance(ctx context.Context, id int64, value float64) (service.BalanceChange, error) {
	...
	return r.setBalanceAndCancelGrantLedger(ctx, id, value)
}

// currentBalance 读取用户当前余额，用户不存在时返回 ErrUserNotFound。
func (r *userRepository) currentBalance(ctx context.Context, id int64) (float64, error) {
	state, err := r.SettleExpiredBalanceGrants(ctx, id)
	if err != nil {
		return 0, err
	}
