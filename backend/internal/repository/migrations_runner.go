...
const cacheUsageSessionIndexMigration = "222_cache_usage_session_index_notx.sql"
const cacheUsageSessionIndex = "idx_usage_logs_session_usage_v2"
...
func prepareNonTransactionalMigration(ctx context.Context, db migrationConnection, name string) error {
	...
	case usageLogsEffectiveModelIndexesMigration:
		...
		return nil
	case cacheUsageSessionIndexMigration:
		return dropInvalidIndexIfPresent(ctx, db, cacheUsageSessionIndex)
	default:
		return nil
	}
}
