...
func TestUsageLogRepositoryGetStatsWithFiltersRequestedModelSource(t *testing.T) {
	...
	mock.ExpectQuery("FROM usage_logs\\s+WHERE COALESCE\\(NULLIF\\(TRIM\\(requested_model\\), ''\\), model\\) = \\$1").
		...
		WillReturnRows(sqlmock.NewRows([]string{
			...
			"account_cost",
			"avg_duration_ms",
		}).AddRow(1, 1, nil, nil, int64(1), int64(2), int64(3), int64(1), int64(3), int64(3), int64(0), int64(0), int64(0), int64(0), int64(0), 1.2, 1.0, 1.2, 20.0))
...
func TestUsageLogRepositoryGetStatsWithFiltersAlwaysReturnsAccountCost(t *testing.T) {
	...
	mock.ExpectQuery("FROM usage_logs").
		...
		}).AddRow(1, 1, nil, nil, int64(50), int64(1000), int64(2000), int64(60), int64(40), int64(40), int64(0), int64(0), int64(0), int64(0), int64(0), 15.0, 12.5, 11.0, 100.0))
