...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	distributionInviteRepository := repository.NewDistributionInviteRepository(client, db)
	distributionInviteService := service.NewDistributionInviteService(distributionInviteRepository, userRepository, groupRepository, affiliateService)
	authService := service.ProvideAuthService(client, userRepository, redeemCodeRepository, refreshTokenCache, configConfig, settingService, emailService, turnstileService, tencentCaptchaService, aliyunCaptchaService, emailQueueService, promoService, subscriptionService, affiliateService, serviceUserPlatformQuotaRepository, distributionInviteService)
	...
	proxyTrafficRecorder := repository.NewProxyTrafficRecorder(db)
	httpUpstream := repository.ProvideHTTPUpstream(configConfig, proxyTrafficRecorder)
	...
	ipReputationChecker := repository.NewIPReputationChecker(configConfig, redisClient)
	adminService := service.ProvideAdminService(userRepository, adminGroupRepository, adminAccountRepository, proxyRepository, apiKeyRepository, redeemCodeRepository, userGroupRateRepository, userRPMCache, billingCacheService, proxyExitInfoProber, proxyLatencyCache, ipReputationChecker, apiKeyAuthCacheInvalidator, client, settingService, subscriptionService, userSubscriptionRepository, privacyClientFactory, openAIGatewayService, affiliateService, compositeModelRouteRepository, compositeRouteResolver, channelService, distributionInviteService)
	...
	cursorQuotaFetcher := service.NewCursorQuotaFetcher(proxyRepository)
	...
	affiliateAdminPermissionRepository := repository.NewAffiliateAdminPermissionRepository(db)
	affiliateAdminPermissionService := service.NewAffiliateAdminPermissionService(affiliateAdminPermissionRepository, userRepository)
	adminAnnouncementHandler := admin.NewAnnouncementHandler(announcementService, affiliateAdminPermissionService)
	...
	tokenRefreshService := service.ProvideTokenRefreshService(accountRepository, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, grokOAuthService, kiroOAuthService, cursorOAuthService, compositeTokenCacheInvalidator, schedulerCache, configConfig, tempUnschedCache, privacyClientFactory, proxyRepository, oAuthRefreshAPI, openAIGatewayService)
	grokOAuthHandler := admin.NewGrokOAuthHandler(grokOAuthService, adminService, grokQuotaService, tokenRefreshService)
	kiroHandler := admin.NewKiroHandler(kiroOAuthService, adminService, compositeTokenCacheInvalidator)
	cursorHandler := admin.NewCursorHandler(cursorOAuthService, adminService, compositeTokenCacheInvalidator)
	...
	distributionUsageRepository := repository.NewDistributionUsageRepository(client, db)
	distributionBalanceRepository := repository.NewDistributionBalanceRepository(client, db)
	distributionDashboardService := service.ProvideDistributionDashboardService(distributionUsageRepository, userRepository, distributionBalanceRepository)
	distributionBalanceService := service.ProvideDistributionBalanceService(client, userRepository, distributionBalanceRepository, apiKeyAuthCacheInvalidator, billingCacheService)
	distributionHandler := admin.NewDistributionHandler(distributionDashboardService, distributionBalanceService, distributionInviteService, adminService, usageService, subscriptionService, affiliateAdminPermissionService)
	upstreamBillingProbeService := service.ProvideUpstreamBillingProbeService(accountRepository, accountTestService, settingService, leaderLockCache, db)
	ollamaCloudUsageService := service.ProvideOllamaCloudUsageService(accountRepository, httpUpstream, settingService, secretEncryptor, configConfig, leaderLockCache, db)
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, grokOAuthHandler, kiroHandler, cursorHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, promptAdminHandler, paymentHandler, affiliateHandler, complianceHandler, auditLogHandler, distributionHandler, upstreamBillingProbeService, ollamaCloudUsageService)
	...
	gatewayHandler := handler.ProvideGatewayHandler(gatewayService, openAIGatewayService, geminiMessagesCompatService, antigravityGatewayService, kiroGatewayService, cursorGatewayService, userService, concurrencyService, billingCacheService, usageService, apiKeyService, usageRecordWorkerPool, errorPassthroughService, contentModerationService, userMessageQueueService, configConfig, settingService, coordinator)
	...
	accountQuotaPatrolService := service.ProvideAccountQuotaPatrolService(accountRepository, accountUsageService)
	...
	v := provideCleanup(client, redisClient, opsMetricsCollector, opsAggregationService, opsAlertEvaluatorService, opsCleanupService, opsScheduledReportService, opsSystemLogSink, proxyTrafficRecorder, opsService, opsIngressRejectAggregator, apiKeyService, authCacheInvalidationWorker, schedulerSnapshotService, tokenRefreshService, accountExpiryService, accountQuotaPatrolService, openAICodexVersionSyncService, proxyExpiryService, subscriptionExpiryService, usageCleanupService, idempotencyCleanupService, batchImageCleanupService, batchImageWorkerRuntime, pricingService, emailQueueService, billingCacheService, usageRecordWorkerPool, subscriptionService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, grokOAuthService, openAIGatewayService, scheduledTestRunnerService, backupService, paymentOrderExpiryService, channelMonitorRunner, channelMonitorV2Aggregator, userPlatformQuotaUsageFlusher, upstreamBillingProbeService, ollamaCloudUsageService, auditLogService, promptService)
