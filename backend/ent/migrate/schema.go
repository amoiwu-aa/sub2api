...
var (
	...
	RedeemCodesColumns = []*schema.Column{
		...
		{Name: "balance_validity_days", Type: field.TypeInt, Default: 0},
		{Name: "group_id", Type: field.TypeInt64, Nullable: true},
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "upstream_credits", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
