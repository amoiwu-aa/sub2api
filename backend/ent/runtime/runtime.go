...
func init() {
	...
	// usagelogDescCacheUsageSource is the schema descriptor for cache_usage_source field.
	usagelogDescCacheUsageSource := usagelogFields[19].Descriptor()
	// usagelog.CacheUsageSourceValidator is a validator for the "cache_usage_source" field. It is called by the builders before save.
	usagelog.CacheUsageSourceValidator = usagelogDescCacheUsageSource.Validators[0].(func(string) error)
	// usagelogDescForcedCacheReadTokens is the schema descriptor for forced_cache_read_tokens field.
	usagelogDescForcedCacheReadTokens := usagelogFields[20].Descriptor()
	// usagelog.ForcedCacheReadTokensValidator is a validator for the "forced_cache_read_tokens" field. It is called by the builders before save.
	usagelog.ForcedCacheReadTokensValidator = usagelogDescForcedCacheReadTokens.Validators[0].(func(int) error)
	...
	// usagelogDescUpstreamCredits is the schema descriptor for upstream_credits field.
	usagelogDescUpstreamCredits := usagelogFields[31].Descriptor()
	// usagelog.DefaultUpstreamCredits holds the default value on creation for the upstream_credits field.
	usagelog.DefaultUpstreamCredits = usagelogDescUpstreamCredits.Default.(float64)
	...
	usagelogDescSessionID := usagelogFields[39].Descriptor()
