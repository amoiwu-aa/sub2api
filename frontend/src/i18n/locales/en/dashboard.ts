export default {
  ...
  keys: {
    ...
    useKeyModal: {
      ...
      grok: {
        description: 'Configure Grok Build, Claude Code, Codex, or OpenCode to send requests through your 环星中转 Grok group.',
        claudeDescription: 'Configure Claude Code to send Messages API traffic through your 环星中转 Grok group.',
        codexDescription: 'Configure Codex to send Responses API traffic through your 环星中转 Grok group.',
