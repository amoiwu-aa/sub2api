export default {
  ...
  keys: {
    ...
    ccSwitchNotInstalled: 'CC-Switch was not detected. Download and install it, then click Import to CCS again. You can also copy the API key manually.',
    ccSwitchDownload: {
      title: 'Open or Install CC-Switch',
      description: 'Importing a configuration requires the CC-Switch desktop app. If it is not installed, choose the version for this device.',
      windows: 'Windows',
      windowsDesc: 'Installer (.msi)',
      macos: 'macOS',
      macosDesc: 'Installer (.dmg)',
      linux: 'Linux',
      linuxDesc: 'AppImage',
      other: 'Other versions',
      otherDesc: 'Portable, ARM, and older releases',
      recommended: 'Recommended for this device',
      afterInstall: 'After installing, return here and click Installed, continue import.',
      continueImport: 'Installed, continue import',
    },
    ccsClientSelect: {
      title: 'Select Import Tool',
      description: 'Choose the tool to import into CC-Switch:',
      claudeCode: 'Claude Code',
      ...
      hermes: 'Hermes',
      hermesDesc: 'Import as Hermes configuration',
    },
    ccsModelSelect: {
