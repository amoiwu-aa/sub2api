export default {
    ...
    channels: {
      ...
      form: {
        ...
        modelBulkEdit: 'Bulk text edit',
        modelBulkEditHint: 'Use one model per line, or separate models with commas or semicolons. Edit or delete anywhere, then press Ctrl/Command + Enter to apply.',
        applyModelBulkEdit: 'Apply list',
        cancelModelBulkEdit: 'Cancel',
        billingMode: 'Billing Mode',
