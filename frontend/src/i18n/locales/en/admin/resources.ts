export default {
    ...
    proxies: {
      ...
      batchInputPlaceholder:
        "Paste one proxy per line, in any of these formats:\n192.168.1.1:1080:user:pass\n192.168.1.1:8080\nuser:pass{'@'}192.168.1.1:1080\nsocks5://user:pass{'@'}192.168.1.1:1080\nhttps://proxy.example.com:443",
      batchInputHint:
        'Credentials may follow the host and port directly, separated by a colon, space, comma or pipe. Lines without a protocol prefix use the default protocol selected above.',
      batchDefaultProtocol: 'Default Protocol',
      batchDefaultProtocolHint:
        'Only applies to lines without an http:// or socks5:// prefix. The wrong protocol will make the proxy fail to connect.',
      parsedCount: '{count} valid',
      invalidCount: '{count} invalid',
      duplicateCount: '{count} duplicate',
      invalidLinesTitle: 'These lines were not recognized and were skipped:',
      invalidLineItem: 'Line {line}: {text}',
      importing: 'Importing...',
      ...
      reputationCached: 'cached',
      reputationISP: 'ISP',
      reputationASN: 'ASN',
      reputationHoster: 'Hosting provider',
      reputationConflict: 'Sources disagree on {flags}; the most conservative answer was used',
      reputationTableSource: 'Source',
      reputationTableType: 'Network type',
      reputationTableFlags: 'Flags',
      reputationTableRisk: 'Risk',
      reputationSourceFailed: 'Lookup failed',
      reputationNoFlags: 'No flags',
      reputationFlagProxy: 'Proxy',
      reputationFlagVPN: 'VPN',
      reputationFlagTor: 'Tor',
      reputationFlagAbuser: 'Abuse history',
      ipTypeDatacenter: 'Datacenter',
      ipTypeResidential: 'Residential',
      ipTypeMobile: 'Mobile',
      ipTypeUnknown: 'Unknown type',
      ipRiskClean: 'Clean',
      ipRiskLow: 'Low risk',
      ipRiskMedium: 'Medium risk',
      ipRiskHigh: 'High risk',
      ipRiskUnknown: 'Unknown risk',
    ...
    redeem: {
      ...
      balanceValidity: 'Credited Balance Validity',
      balanceValidityHint:
        'The countdown starts when the code is redeemed. Any unused credited balance expires automatically.',
      permanentBalance: 'Permanent',
      customBalanceValidityDays: 'Custom balance validity days',
      balanceValidityDaysRequired: 'Please enter a valid credited balance validity',
      balanceValidityLabel: 'Use within {days} days after redemption',
    ...
    announcements: {
      ...
      managedAudienceNotice: 'Announcements you publish are visible only to your managed users. You cannot view or edit global announcements or announcements from other distributors.',
      ...
      targetingSummaryManagedUsers: 'My managed users',
      targetingSummaryDistributorUsers: 'Users managed by distributor #{id}',
