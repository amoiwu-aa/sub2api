export default {
    ...
    dashboard: {
      ...
      todayCacheHitRate: 'Cache Read Coverage (Today)',
      totalCacheHitRate: 'Cache Read Coverage (Total)',
      cacheHitRate: 'Cache Read Coverage',
      cacheHitChartTitle: 'Cache Read Coverage',
      todayCacheReadCoverage: 'Cache Read Coverage (Today)',
      totalCacheReadCoverage: 'Cache Read Coverage (Total)',
      ...
      modelFilter: 'Filter cache statistics by model',
      cacheUserFilter: 'Filter cache statistics by user',
      cacheUserSearchPlaceholder: 'Search user email or ID',
      clearCacheUserFilter: 'Clear user filter',
      cacheHitTokens: 'Provider Cache Read',
      providerCacheReadTokens: 'Provider Cache Read',
      cacheCreationTokens: 'Cache Creation',
      uncachedInputTokens: 'Uncached Input',
      promptTokensTotal: 'Prompt Tokens',
      cacheReadShort: 'Read',
      providerCacheReadShort: 'Provider Read',
      ...
      billingAdjustmentTooltip:
        'Tokens moved from ordinary input into cache read for accounting. Shown separately and excluded from real cache-read coverage.',
    ...
    backup: {
      ...
      r2Guide: {
        ...
        step1: {
          ...
          line2: 'Click "Create bucket", enter a name (e.g. ringstar-backups), choose a region',
