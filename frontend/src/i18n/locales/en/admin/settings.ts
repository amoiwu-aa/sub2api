export default {
    settings: {
      ...
      features: {
        ...
        redeemShop: {
          title: 'Card-shop purchase guide',
          description: 'Show a card-shop purchase entry on the Redeem tab of Recharge / Subscription. Users buy a code in the shop, then return here to redeem it.',
          enabled: 'Enable card-shop purchase entry',
          enabledHint: 'When on, a buy button appears at the top of the Redeem tab. Turning it off still allows redeeming codes.',
          url: 'Card-shop URL',
          urlHint: 'Must be an absolute http(s) URL. Opens in a new tab. Required when enabled.',
          urlPlaceholder: 'https://shop.example.com/item/xxxx',
          urlRequired: 'Card-shop URL is required when the purchase entry is enabled',
          buttonText: 'Button label',
          buttonTextHint: 'Leave empty to use the default “Buy from shop”. Max 40 characters.',
          buttonTextPlaceholder: 'Buy from shop',
          guide: 'Guide text',
          guideHint: 'Shown next to the buy button. Leave empty to use the default copy. Max 500 characters.',
          guidePlaceholder: 'Buy a plan in the shop first, then paste the redeem code below.',
        },
        riskControl: {
          title: 'Risk Control',
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for RingStar end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for RingStar end-user login',
      ...
      upstreamBillingProbe: {
        ...
        description: 'Periodically retrieve rates declared by upstream RingStar sites. Account rates change only when the separate sync switch is enabled.',
      ...
      site: {
        ...
        customerService: {
          title: 'Customer Support Entry',
          description: 'Show a support entry in the signed-in header with a WeChat group QR code and copyable WeChat ID.',
          enabled: 'Show support button',
          enabledHint: 'When enabled, both administrators and users can open support details from the header.',
          buttonText: 'Button text',
          buttonTextPlaceholder: 'Support',
          buttonTextHint: 'Leave empty to use the default text for the current language.',
          dialogTitle: 'Dialog title',
          dialogTitlePlaceholder: 'Customer Support',
          dialogTitleHint: 'Leave empty to use the default title for the current language.',
          content: 'Support description',
          contentPlaceholder: 'For example: Scan to join the support group. Service hours: 09:00-22:00.',
          wechatId: 'Support WeChat ID',
          wechatIdPlaceholder: 'e.g., RingStarSupport',
          qrImage: 'WeChat group QR code',
          qrImageHint: 'PNG, JPG, or WebP. Max 300KB. A clear square QR image is recommended.'
        },
      ...
      payment: {
        ...
        externalRedeemPurchase: 'Recharge Code Purchase Button',
        externalRedeemPurchaseHint: 'Shows an external purchase button on the user top-up page. Users redeem the code on the Redeem tab of this page after purchase.',
        externalRedeemPurchaseURL: 'Purchase URL',
        externalRedeemPurchaseURLPlaceholder: 'https://pay.example.com/item/xxxx',
        externalRedeemPurchaseLabel: 'Button Label',
        externalRedeemPurchaseLabelPlaceholder: 'Buy a Recharge Code',
        ...
        easypayCustomMethodsHint: 'Add provider-specific methods supported by this EasyPay endpoint. The payment type is stored on RingStar orders; the upstream type is sent as EasyPay type.',
