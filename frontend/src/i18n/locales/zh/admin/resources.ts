export default {
    ...
    proxies: {
      ...
      reputationTitle: 'IP 信誉',
      reputationCached: '缓存结果',
      reputationISP: '运营商',
      reputationASN: 'ASN',
      reputationHoster: '机房',
      reputationConflict: '数据源在「{flags}」上判定不一致，已按最保守的结果取值',
      reputationTableSource: '数据源',
      reputationTableType: '网络类型',
      reputationTableFlags: '命中标记',
      reputationTableRisk: '风险',
      reputationSourceFailed: '查询失败',
      reputationNoFlags: '无命中',
      reputationFlagProxy: '代理',
      reputationFlagVPN: 'VPN',
      reputationFlagTor: 'Tor',
      reputationFlagAbuser: '滥用记录',
      ipTypeDatacenter: '机房',
      ipTypeResidential: '住宅',
      ipTypeMobile: '移动网络',
      ipTypeUnknown: '类型未知',
      ipRiskClean: '纯净',
      ipRiskLow: '低风险',
    ...
    redeem: {
      ...
      validityDays: '有效天数',
      balanceValidity: '到账额度有效期',
      balanceValidityHint: '从用户兑换成功时开始计算，未用完额度会在到期后自动失效。',
      permanentBalance: '永久有效',
      customBalanceValidityDays: '自定义额度有效天数',
      balanceValidityDaysRequired: '请输入有效的额度使用天数',
      balanceValidityLabel: '兑换后 {days} 天内使用',
      codeExpiry: '兑换码过期',
      neverExpires: '永不过期',
    ...
    announcements: {
      ...
      managedAudienceNotice: '您发布的通知只会展示给自己名下的用户，无法查看或修改全站及其他分销管理员的公告。',
      ...
      targetingSummaryManagedUsers: '我的名下用户',
      targetingSummaryDistributorUsers: '分销管理员 #{id} 的名下用户',
