export default {
    settings: {
      ...
      features: {
        ...
        redeemShop: {
          title: '卡网购买引导',
          description: '在用户「充值/订阅」页的兑换页签展示卡网购买入口。用户在卡网下单拿到兑换码后，回到本站兑换。',
          enabled: '启用卡网购买入口',
          enabledHint: '开启后在「充值/订阅」的兑换页签顶部展示购买按钮。关闭后仍可兑换，只是不展示外链。',
          url: '卡网链接',
          urlHint: '必须是 http(s) 绝对地址，将在新标签页打开。启用时必填。',
          urlPlaceholder: 'https://shop.example.com/item/xxxx',
          urlRequired: '启用卡网购买入口时必须填写卡网链接',
          buttonText: '按钮文案',
          buttonTextHint: '留空则使用默认文案「去卡网购买」。最多 40 字。',
          buttonTextPlaceholder: '去卡网购买',
          guide: '引导说明',
          guideHint: '展示在购买按钮旁。留空则使用默认说明。最多 500 字。',
          guidePlaceholder: '先到卡网购买套餐，支付完成后把兑换码粘贴到下方。',
        },
        riskControl: {
          title: '风控中心',
      ...
      linuxdo: {
        ...
        description: '配置 LinuxDo Connect OAuth，用于 RingStar 用户登录',
      ...
      dingtalk: {
        title: '钉钉登录',
        description: '配置钉钉 OAuth，用于 RingStar 用户登录',
      ...
      upstreamBillingProbe: {
        title: '上游倍率自动探测',
        description: '定期获取 API Key 账号所连接上游 RingStar 站点声明的计费倍率；只有另行开启“同步上游声明倍率”的账号才会更新账号倍率。',
        enabled: '启用全局自动探测',
      ...
      site: {
        ...
        customerService: {
          title: '客服售后入口',
          description: '在登录后的顶部导航展示客服入口，用户可查看微信群二维码并复制微信号。',
          enabled: '显示客服售后按钮',
          enabledHint: '开启后，管理员和普通用户都能从顶部导航打开客服信息。',
          buttonText: '按钮文字',
          buttonTextPlaceholder: '客服售后',
          buttonTextHint: '留空时使用当前语言的默认文案。',
          dialogTitle: '弹窗标题',
          dialogTitlePlaceholder: '客服售后',
          dialogTitleHint: '留空时使用当前语言的默认标题。',
          content: '客服说明',
          contentPlaceholder: '例如：扫码加入售后微信群，工作时间 09:00-22:00。',
          wechatId: '客服微信号',
          wechatIdPlaceholder: '例如：RingStarSupport',
          qrImage: '微信群二维码',
          qrImageHint: 'PNG、JPG 或 WebP，最大 300KB。建议使用清晰的正方形二维码图片。'
        },
        docUrl: '文档链接',
      ...
      payment: {
        ...
        externalRedeemPurchase: '购买充值码按钮',
        externalRedeemPurchaseHint: '在用户充值页显示外部购买按钮。用户购买卡密后，可在同一页的「兑换」页签兑换。',
        externalRedeemPurchaseURL: '购买链接',
        externalRedeemPurchaseURLPlaceholder: 'https://pay.example.com/item/xxxx',
        externalRedeemPurchaseLabel: '按钮文案',
        externalRedeemPurchaseLabelPlaceholder: '购买充值码',
        providerEasypay: '易支付',
        ...
        easypayCustomMethodsHint: '添加当前易支付服务商额外支持的支付方式。支付方式会记录到 RingStar 订单中，上游 type 会作为易支付 type 参数提交。',
