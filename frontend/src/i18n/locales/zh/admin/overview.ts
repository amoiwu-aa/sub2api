export default {
    ...
    dashboard: {
      ...
      output: '输出',
      cacheToday: '今日缓存',
      todayCacheHitRate: '今日缓存读取覆盖率',
      totalCacheHitRate: '累计缓存读取覆盖率',
      cacheHitRate: '缓存读取覆盖率',
      cacheHitChartTitle: '缓存读取覆盖率',
      todayCacheReadCoverage: '今日缓存读取覆盖率',
      totalCacheReadCoverage: '累计缓存读取覆盖率',
      ...
      currentRange: '当前范围',
      allModels: '全部模型',
      modelFilter: '按模型筛选缓存统计',
      cacheUserFilter: '按用户查看缓存统计',
      cacheUserSearchPlaceholder: '搜索用户邮箱或 ID',
      clearCacheUserFilter: '清除用户筛选',
      cacheHitTokens: '上游缓存读取',
      providerCacheReadTokens: '上游缓存读取',
      cacheCreationTokens: '缓存创建',
      uncachedInputTokens: '普通输入',
      promptTokensTotal: '提示词 Token',
      cacheReadShort: '读取',
      providerCacheReadShort: '上游读取',
      cacheCreateShort: '创建',
      ...
      billingAdjustmentTooltip:
        '因计费策略从普通输入移入缓存读取的 Token；单独展示，不计入真实缓存读取覆盖率。',
      performance: '性能指标',
      avgResponse: '平均响应',
      averageTime: '平均时间',
      active: '活跃',
    ...
    backup: {
      ...
      r2Guide: {
        ...
        step1: {
          ...
          line2: '点击「创建存储桶」，输入名称（如 ringstar-backups），选择区域',
          line3: '点击创建完成'
        },
        step2: {
          title: '创建 API 令牌',
