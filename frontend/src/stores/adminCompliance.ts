...
const FALLBACK_ZH_PHRASE = '我已阅读、理解并同意 RingStar 部署与运营合规承诺'
const FALLBACK_EN_PHRASE = 'I have read, understood, and agree to the RingStar Deployment and Operation Compliance Commitment'
