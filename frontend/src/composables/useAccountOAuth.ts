...
export type AuthInputMethod = 'manual' | 'cookie' | 'refresh_token' | 'mobile_refresh_token' | 'session_token' | 'access_token' | 'chatgpt_cookie' | 'codex_session' | 'agent_identity' | 'codex_pat' | 'sso_cookie'
