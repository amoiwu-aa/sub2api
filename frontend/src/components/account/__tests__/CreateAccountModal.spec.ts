...
describe('CreateAccountModal OpenAI long-context billing', () => {
  ...
  it('shows the enforced Grok Bot model restriction for Sand login', async () => {
    const wrapper = mountModal()
    await selectButtonByText(wrapper, 'Cursor')
    await selectButtonByText(wrapper, 'admin.accounts.cursor.apiToken')
