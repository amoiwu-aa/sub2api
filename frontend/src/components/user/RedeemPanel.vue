<template>
  <div class="mx-auto max-w-2xl space-y-6">
      <!-- Step 1: buy from the configured card shop -->
      <div
        v-if="shop.visible"
        class="card border-primary-200 bg-primary-50/60 dark:border-primary-800/50 dark:bg-primary-900/20"
      >
        <div class="p-6">
          <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div class="flex items-start gap-4">
              ...
              >
                <span class="text-sm font-semibold text-primary-700 dark:text-primary-300">1</span>
              </div>
              <div>
                ...
                <p class="mt-1 text-sm leading-relaxed text-gray-600 dark:text-dark-300">
                  {{ shop.description || t('redeem.shop.description') }}
                </p>
              </div>
            </div>
            <a
              ...
              class="btn btn-primary shrink-0 px-4 py-2.5 text-sm font-medium"
            >
              <span>{{ shop.buttonText || t('redeem.shop.button') }}</span>
      ...
      <div class="card">
        <div class="p-6">
          <div v-if="shop.visible" class="mb-5 flex items-start gap-4">
            <div
              class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-gray-100 dark:bg-dark-800"
            >
              <span class="text-sm font-semibold text-gray-700 dark:text-dark-200">2</span>
            </div>
            <div>
              <p class="text-xs font-medium uppercase tracking-wide text-gray-500 dark:text-dark-400">
                {{ t('redeem.shop.redeemStep') }}
              </p>
              <h3 class="mt-1 text-base font-semibold text-gray-900 dark:text-white">
                {{ t('redeem.shop.redeemTitle') }}
              </h3>
            </div>
          </div>
