<template>
  ...
  <!-- Cursor logo mark (isometric cube) -->
  <svg v-else-if="platform === 'cursor'" :class="sizeClass" viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 1.5 2.75 6.75 12 12l9.25-5.25L12 1.5ZM2 8.47v9.06L11.25 22.8v-9.06L2 8.47Zm20 0-9.25 5.27v9.06L22 17.53V8.47Z" />
  </svg>
  <!-- Kiro logo mark (ghost) -->
  <svg v-else-if="platform === 'kiro'" :class="sizeClass" viewBox="0 0 24 24" fill="currentColor" fill-rule="evenodd" clip-rule="evenodd">
    <path d="M12 1.75A7.75 7.75 0 0 0 4.25 9.5v12.06l2.9-2.32 2.35 1.88L12 19.24l2.5 2 2.35-1.88 2.9 2.32V9.5A7.75 7.75 0 0 0 12 1.75Zm-2.75 8.5a1.25 1.25 0 1 1 0-2.5 1.25 1.25 0 0 1 0 2.5Zm5.5 0a1.25 1.25 0 1 1 0-2.5 1.25 1.25 0 0 1 0 2.5Z" />
  </svg>
